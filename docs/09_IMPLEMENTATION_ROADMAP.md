...
- [Done] Add per-pet TALK holding anchors: derive normalized attachment from frame 34,
  persist it in owner revision 5, mirror it with direction and keep the pet sprite above
  the speech box so the hand covers the attachment edge.
