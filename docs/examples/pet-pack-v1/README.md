...
Sprite `sprites/sunny-cat.png` được tạo riêng cho Cute Pet bằng built-in image generation, sau đó loại nền chroma thành PNG RGBA. Pack không sử dụng source hoặc asset của ứng dụng đối thủ.
