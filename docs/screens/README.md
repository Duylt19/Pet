...
| `home` | `ui/home/HomeScreen` | Mixed/Swarm loại trừ nhau, global enable, visibility từng Mixed pet, Rewarded/Premium Swarm |
| `pet_catalog/{target}/{slotIndex}` | `ui/catalog/PetCatalogScreen` | Lưới GitHub raw/cache; selection được route về Mixed slot hoặc Swarm pack |
