...
| Owner pet catalog | `OwnerPetCatalogRepository`, `data/remote`, `ui/catalog` | Active private GitHub raw source, 1.062 pets including 36 original WC 2026 packs/864 frames + cached metadata + authenticated thumbnail + verified on-demand ZIP Set |
