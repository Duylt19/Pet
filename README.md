...
- Home điều khiển Start/Stop selected pet, đồng thời mở Catalog, Settings và Premium.
- Catalog hỗ trợ built-in pet, preview/select và import pack `.zip` qua schema v1 được validate an toàn.
