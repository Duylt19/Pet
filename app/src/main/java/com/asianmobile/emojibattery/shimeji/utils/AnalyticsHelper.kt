...
enum class ScreenName(val value: String) {
    ...
    BATTERY_TEMPLATE_PICKER("battery_template_picker"),
    BATTERY_BACKGROUND_THEME_PICKER("battery_background_theme_picker"),
    ...
    BATTERY_CLOCK_EDITOR("battery_clock_editor"),
